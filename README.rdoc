= JECKYL - Jumpin' Ermin's Configurator for Kwit and easY Linux services
...
needs to be a method called "set_log_dir". Each method should be called with one parameter value,
...
jeckyl-0.0.2 - update to add comments, generator and checker.
